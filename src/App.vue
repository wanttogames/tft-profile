  ...
  <div class="app-shell">
    <header class="topbar">
      <a
        class="brand"
        href="#"
        aria-label="TFT Profile 홈"
        @click.prevent="navigateSection('profile')"
      >
              ...
              <div class="profile-identity">
                ...
                <div>
                  ...
                  <h2>
                    ...
                    }}<span class="muted"> #{{ data.account.tagLine }}</span>
                  </h2>
                  <p>
            ...
            <div class="two-grid">
              <section class="panel">
                ...
                <details class="method">
                  ...
                  <p>
                    리롤형: 3성 유닛이 있고 최종 레벨 ≤ 8. 그 외 최종 레벨 ≥ 9는 Fast 9형, 8은 Fast
                    8형, 나머지는 기타입니다. 레벨업 속도는 확인되지 않으므로 명칭은 보드 성향의
                    추정입니다. 연승·연패 운영과 경기 중 전환은 판정하지 않습니다.
                  </p>
                </details>
              </section>
              <section class="panel">
                ...
                <p class="small muted">
                  최소 10경기 · 부분 집단 비교는 각 3경기 이상. 관찰된 관계이며 원인 분석은
                  아닙니다.
                </p>
              </section>
            </div>
            <div class="two-grid">
              ...
              <section class="panel">
                ...
                <div class="diversity">
                  ...
                  <p>
                    {{ diversity.valid }}경기에서<br /><b
                      >{{ diversity.unique }}개의 주요 특성 조합</b
                    >
                  </p>
                </div>
                <div
                  v-for="([key, count], i) in diversity.top.slice(0, 3)"
                  :key="key"
                  class="deck-row"
                >
